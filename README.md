...
Antares Users Module changelog can be found in release notes [antaresproject.io/docs/site/getting_started/changelog#users](http://antaresproject.io/docs/site/getting_started/changelog/index.html#users).
